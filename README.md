...
For your IDEs (Arudino IDE or Visual Studio Code) to find the included libaries, modify the variable the `sketchbook.path` in the following configuration file:
